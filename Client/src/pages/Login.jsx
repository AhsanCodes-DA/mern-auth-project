...
const Login = () => {
  const { backendUrl, setIsLoggedIn, getUserData } = useContext(AppContent); // Fixed typo
  
  const navigate = useNavigate();

  const [state, setState] = useState('Sign up'); // Used for toggling between Sign up and Login
